                                  ...
                                  <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={12} md={3} style={{ position: 'relative' }}>
                                      <TextField
                                        ...
                                        value={factura.valorFuturo ? formatNumberWithThousandsSeparator(Math.floor(factura.valorFuturo)) : ""} // Aplicamos el formato solo en la visualización, usando Math.floor para eliminar decimales
                                        onChange={(e) => {
                                          // Eliminar caracteres no numéricos para mantener el valor limpio
                                          const rawValue = e.target.value.replace(/[^\d]/g, ""); 
                                          const valorFuturoManual = parseFloat(rawValue) || 0;

                                          // Establecer el valor limpio en el estado, sin formato
